...
public class Taller_3_Modelado_de_objetos {
    ...
    public static void main(String[] args) throws IOException {
        /**
         * Variable de validación para seguir ingresando nuevas canciones a la Playlist.
         */
        String n = "0";
        String p = "0";
        String genero;
        ...
        int j;
        /**
         * Arreglo de la clase Song que representa la Biblioteca principal de archivos de música.
         */
        ...
        /**
         * Objeto de la clase Music_Library que permite el acceso a los diferentes métodos de creación de Playlist, filtrado y ordenamiento.
         */
        Music_Library m = new Music_Library();
        Music_Library pl = new Music_Library();
        /**
         * Arreglo de la clase Song que almacenará la Playlist creada por el usuario.
         */
        Song[] playlist = null;
        /**
         * Arreglo de la clase Song que almacenará el filtro de los archivos de música filtrados por un género especificado por
         * el usuario.
         */
        ...
        /**
         * Variable que representa el tamaño del arreglo de la biblioteca principal.
         */
        int l = main_library.length;
        /**
         * Variable que representa la opción del menú que desea el usuario, por defecto se establece en cero para que el usuario
         * pueda ingresar por primera vez al menú.
         */
        String option="0";
        /**
        ...
        /**
         * Ciclo While que permite la validación de los datos ingresados por teclado dentro de las opciones permitidas.
         */
        ...
        switch (option) {
            ...
            case "4":
                ...
                System.out.println("La lista ordernada por duraciÃ³n es:");
                for (int o = 0; o < i; o++) {
